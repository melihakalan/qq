...
public class SetQuestionImageActivity extends Activity {

    private float fDragY = 0;
    private ImageView ivQuestionImageFull;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_question_image);

        QQData.m_lActivityList.add(SetQuestionImageActivity.this);

        ivQuestionImageFull = (ImageView) findViewById(R.id.ivQuestionImageFull);

        ivQuestionImageFull.setOnTouchListener(new View.OnTouchListener() {
            @Override
        ...
        if (QQData.m_actHome.fPostQuestion.bmQuestionImage != null)
            ivQuestionImageFull.setImageBitmap(QQData.m_actHome.fPostQuestion.bmQuestionImage);
    }
    ...
    public void onResume() {
        ...
        QQData.m_lVisibleActivityList.add(SetQuestionImageActivity.this);
    }
    ...
    protected void onPause() {
        ...
        QQData.m_lVisibleActivityList.remove(SetQuestionImageActivity.this);
        if (isFinishing()) {
            QQData.m_lActivityList.remove(SetQuestionImageActivity.this);
        }
    }
    ...
    public void getNewPhoto(Uri uriImage, boolean taking) {
        ...
        if (bmPhoto != null) {
            bmNewPhoto = bmPhoto;
            ivQuestionImageFull.setImageBitmap(bmNewPhoto);
        }
    }

    public void changeQuestionImage(View v) {
        Intent Picker = new Intent(Intent.ACTION_PICK);
        Picker.setType("image/*");
        Bundle translate = ActivityOptions.makeCustomAnimation(SetQuestionImageActivity.this, R.anim.act_slide_in_left, R.anim.act_slide_out_left).toBundle();
        startActivityForResult(Picker, 100, translate);
    }

    public void saveQuestionImage(View v) {
        if (bmNewPhoto != null) {
            Bitmap bmThumb = getBitmapThumb(bmNewPhoto);
            QQData.m_actHome.fPostQuestion.updateQuestionImage(bmNewPhoto, bmThumb);
            finish();
        } else {
            finish();
        }
    ...
    public void removeQuestionImage(View v) {
        QQData.m_actHome.fPostQuestion.updateQuestionImage(null, null);
        finish();
    }
    ...
    public void takeQuestionImage(View v) {
